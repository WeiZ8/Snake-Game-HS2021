...
The gaming interface shows the score at the top left corner. To play the game the user navigates the snake, which is the green block, using the arrow keys. We based our code on the code of Edureka (https://www.edureka.co/blog/snake-game-with-pygame/) and implemented **three additional features**: 
...
* A sound effect is played once a food item is eaten or when the snake collides with the obstacle, the wall, or itself. 
