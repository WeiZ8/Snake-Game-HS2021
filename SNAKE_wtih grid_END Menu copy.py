    ...
    for y in range(0, int(GRID_HEIGHT)):
        for x in range(0, int(GRID_WIDTH)):
            if (x + y) % 2 == 0:
                ...
                pygame.draw.rect(surface, LIGHT_PINK1, r)
            else:
                rr = pygame.Rect((x * GRID_SIZE, y * GRID_SIZE), (GRID_SIZE, GRID_SIZE))
                pygame.draw.rect(surface, LIGHT_PINK2, rr)
...
#Text for options menu
        ...
        Info_1 = center_text('Eat fruit to get longer', font_style, (255, 255, 255), screen, SCREEN_WIDTH/2, SCREEN_HEIGHT-30*12)
        Info_2 = center_text('One point', font_style, (255, 255, 255), screen, SCREEN_WIDTH/2, SCREEN_HEIGHT-30*10)
        Info_3 = center_text('Five points', font_style, (255, 255, 255), screen, SCREEN_WIDTH/2, SCREEN_HEIGHT-30*8)
...
def game_over(score):
        ...
        while 1:
            ...
            game_over_message = font_style.render('You Lost' , True , (255,0,0))
            #showing 'You score was SCORE'
            game_over_score = font_style.render(f'Your Score was {score}' , True , (255,255,255))
